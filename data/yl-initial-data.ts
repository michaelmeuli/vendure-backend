    ...
    paymentMethods: [
        ...
        },
        {
            ...
            handler: {
                code: 'braintree',
                arguments: [
                    { name: 'merchantId', value: <string>process.env.MERCHANT_ID },
                    { name: 'publicKey', value: <string>process.env.PUBLIC_KEY },
                    { name: 'privateKey', value: <string>process.env.PRIVATE_KEY }
                ],
            },
        },
    ],
